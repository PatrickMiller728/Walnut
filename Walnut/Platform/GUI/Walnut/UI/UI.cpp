...
namespace Walnut::UI {
		...
		ImVec2 rectMin, ImVec2 rectMax)
	{
		...
		if (ImGui::IsItemActive())
			drawList->AddImage(reinterpret_cast<ImTextureID>(imagePressed->GetDescriptorSet()), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintPressed);
		else if (ImGui::IsItemHovered())
			drawList->AddImage(reinterpret_cast<ImTextureID>(imagePressed->GetDescriptorSet()), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintHovered);
		else
			drawList->AddImage(reinterpret_cast<ImTextureID>(imagePressed->GetDescriptorSet()), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintNormal);
	};
